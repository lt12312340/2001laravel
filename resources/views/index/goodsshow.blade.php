				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom"><img jqimg="{{$gallery[0]->img_url}}" src="{{$gallery[0]->img_url}}" width="400" height="400"/></span>
						</div>
						<!--下方的缩略图-->
						<div class="spec-scroll">
							...
							<div class="items">
								<ul>
									...
									<li><img src="{{$v->img_url}}" bimg="{{$v->img_url}}" onmousemove="preview(this)" /></li>
									@endforeach
								</ul>
							</div>
							<a class="next">&gt;</a>
				...
				<div class="fr itemInfo-wrap">
					...
					<div class="summary">
						<div class="summary-wrap">
							...
							<div class="fl price">
								<i>¥</i>
								<em id="price">{{$goods->goods_price}}</em>
								<span>降价通知</span>
							</div>
							<div class="fr remark">
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<dd><a href="javascript:;" @if($i==0) class="selected" @endif goods_attr_id="{{$key}}">{{$val}}<span title="点击取消选择">&nbsp;</span></a></dd>
...
$(function(){
	...
	function getgoodsprice(){
		...
		if(goods_attr_id.length){
			...
			$.get('/goods/getattrprice',{goods_attr_id:goods_attr_id,goods_id:goods_id},function(res){
				$('#price').html(res.data.goods_price);
			},'json');
		}
	}
