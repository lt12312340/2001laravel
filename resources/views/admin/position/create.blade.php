...
@section('content')
    ...
    @endif
<form class="layui-form" action="{{url('/position/store')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="layui-form-item">
            <label class="layui-form-label">广告位名称:</label>
            <div class="layui-input-block">
            <input type="text" name="position_name" lay-verify="title" autocomplete="off" placeholder="请输入广告位名称" class="layui-input">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
            <input type="text" name="ad_width" lay-verify="title" autocomplete="off" placeholder="请输入广告位宽度" class="layui-input">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
            <input type="text" name="ad_height" lay-verify="title" autocomplete="off" placeholder="请输入广告位高度" class="layui-input">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
            <input type="text" name="position_desc" lay-verify="title" autocomplete="off" placeholder="请输入广告位描述" class="layui-input">
            <b style="color:000; font-family:'仿宋'" >{{$errors->first('brand_desc')}}</b> 
            </div>
        </div>
