...
@section('content')
    ...
    @endif
<form class="layui-form" action="{{url('/admin/updata/'.$res->admin_id)}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="layui-form-item">
            <label class="layui-form-label">管理员名称:</label>
            <div class="layui-input-block">
            <input type="text" name="admin_account" value="{{$res->admin_account}}" lay-verify="title" autocomplete="off" placeholder="请输入品牌名称" class="layui-input">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-upload-drag" id="test10">
              ...
              <p>点击上传，或将文件拖拽到此处</p>
              <div @if(!$res->my_img)  class="layui-hide" @endif id="uploadDemoView" >
                <hr>
                <img src="{{$res->my_img}}" alt="上传成功后渲染" style="max-width: 196px">
              </div>
              
            </div>
            <input type="hidden" name="my_img" @if($res->my_img) value="{{$res->my_img}}" @endif>
            </div>
        </div>
